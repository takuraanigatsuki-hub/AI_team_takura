"""Обучение агентов друг с другом — варианты и проекты в рабочий чат."""
...
async def share_learning_to_work_chat(agent, material: dict, room_manager) -> None:
    """После изучения — опубликовать вариант/идею в рабочий чат."""
    if not room_manager:
        return
...
async def peer_discussion_round(room_manager, agents: dict) -> None:
    """Короткий диалог 2–3 агентов по теме — в рабочий чат."""
    pool = [
