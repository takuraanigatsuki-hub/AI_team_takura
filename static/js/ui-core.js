...
(function (global) {
    ...
    function getUiMode(user) {
        ...
        if (user.is_support || user.role === 'support') return 'support';
    ...
    const VIEW_META = {
        ...
        dashboard: { icon: '📊', name: 'Панель', sub: 'Обзор комнаты' },
        projects: { icon: '📦', name: 'Проекты', sub: 'Готовые артефакты' },
        sites: { icon: '🌐', name: 'Сайты', sub: 'Готовые HTML-страницы' },
